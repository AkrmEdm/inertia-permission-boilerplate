    ...
    <AdminLayout>
        ...
        <div class="max-w-7xl mx-auto py-4">
            <div class="flex justify-between">
                <h1>User Index</h1>
                <Link :href="route('users.create')" class="px-3 py-2 text-white font-semibold bg-sky-500 hover:bg-sky-700 rounded">New User</Link>
            </div>
                        ...
                        <TableRow v-for="user in users" :key="user.id" class="border-b">
                            ...
                            <TableDataCell class="space-x-4">
                                ...
                                <Modal :show="showConfirmDeleteUserModal" @close="closeModal">
                                    <div class="p-6">
                                        <h2 class="text-lg font-semi-bold text-slate-800">Are you sure to delete this user?</h2>
